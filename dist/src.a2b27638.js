...
function _getUserData() {
  _getUserData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var dbs, _yield$Promise$all, _yield$Promise$all2, dbName, vaultData, dbData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          dbs = {
          ...
          _context.next = 3;
          return Promise.all([(0, _databases.central)(id), (0, _databases.vault)(id)]);
        case 3:
          _yield$Promise$all = _context.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
          dbName = _yield$Promise$all2[0];
          vaultData = _yield$Promise$all2[1];
          _context.next = 9;
          return dbs[dbName](id);
        case 9:
          dbData = _context.sent;
          console.log(JSON.stringify(_objectSpread(_objectSpread({}, dbData), vaultData)));
